    ...
    def _build_message_response(
        ...
        return QueueMessageResponse(
            ...
            sender=SenderInfo(
                ...
                email=sender.email,
                realName=sender.real_name,
                departmentName=sender.department_name,
            ),
            ...
            return [
                {
                    ...
                    "realName": user_map[c.contact_user_id].real_name,
                    "departmentName": user_map[c.contact_user_id].department_name,

...
function ChatAreaContent({
  ...
  const streamHandlers = useChatStreamHandlers({
    ...
    enableWebSearch: chatState.enableWebSearch,
  ...
  const inputCardProps = {
    ...
    enableReasoning: chatState.enableReasoning,
    setEnableReasoning: chatState.setEnableReasoning,
    enableClarification: chatState.enableClarification,
    setEnableClarification: chatState.setEnableClarification,
    enableWebSearch: chatState.enableWebSearch,
    setEnableWebSearch: chatState.setEnableWebSearch,
    selectedSearchEngine: chatState.selectedSearchEngine,
    setSelectedSearchEngine: chatState.setSelectedSearchEngine,
    searchEngines: chatState.searchEngines,
